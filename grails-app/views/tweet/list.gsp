			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="time" title="${message(code: 'tweet.time.label', default: 'Time')}" />
				...
				<g:each in="${tweetInstanceList}" status="i" var="tweetInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tweetInstance.id}">${fieldValue(bean: tweetInstance, field: "message")}</g:link></td>
					
						<td><g:formatDate date="${tweetInstance.time}" /></td>
