	...
	<body>
		...
		<div id="show-tweet" class="content scaffold-show" role="main">
			...
			<ol class="property-list tweet">
				...
				<g:if test="${tweetInstance?.time}">
				<li class="fieldcontain">
					<span id="time-label" class="property-label"><g:message code="tweet.time.label" default="Time" /></span>
					
						<span class="property-value" aria-labelledby="time-label"><g:formatDate date="${tweetInstance?.time}" /></span>
